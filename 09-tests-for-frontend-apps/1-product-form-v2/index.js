//import DraggableItem from '../../2-sortable-list/src/draggableItem.js';
import SortableList from '../2-sortable-list/index.js';

//import DraggableItem from '../../2-sortable-list/src/index.js';
...
export default class ProductForm {
  ...
  renderProductData(categories, product) {
    if (product) {
      this.element = this.getProductFormHTML(categories, product);
    ...
    element.innerHTML = this.getErrorPageHTML();
  ...
  getProductFormHTML(
    ...
    const imageListContainer = this.getImageList(product.images);
    ...
    const listCont = element.querySelector('[data-element = "sortable-list-container"]');
    const imgUpload = element.querySelector('[data-element = "uploadImage"]');

    listCont.insertBefore(imageListContainer, imgUpload);
  ...
  getImageList(images = []) {
    const imageElements = images.map(image => {
      ...
      dummy.innerHTML = this.getImageHTML(image.url, image.source);
  ...
  getSubElements(element) {
    ...
    subElements.imageListContainer = this.element.querySelector('.sortable-list');
  ...
  destroy() {
    this.remove();
    //this.imageListContainer.destroy();
